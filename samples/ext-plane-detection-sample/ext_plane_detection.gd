extends OpenXRExtPlaneDetector

@export var plane_display_scene: PackedScene = null
var plane_displays: Dictionary[OpenXRExtPlaneTracker, Node] = {}


func _ready() -> void:
	print("ext_plane_detection::_ready: OpenXRExtPlaneDetectionExtension.is_plane_detection_supported: ", OpenXRExtPlaneDetectionExtension.is_plane_detection_supported())
...
func update_plane_displays():
	...
	if plane_display_scene != null:
		# LuNo: debug/testing
		print("ext_plane_detection::update_plane_displays: Instantiating new scene based on scene template!")
	...
	# LuNo: debug/testing
	#else:
		#print("ext_plane_detection::update_plane_displays: There is no plane display scene template defined, cannot instantiate new scene!")
